...
export function Logo({ className }: LogoProps) {
  return (
    ...
    >
      {/* UN Official Emblem Map and Laurel */}
      ...
      <path d="M28 28L72 72" stroke="currentColor" strokeWidth="0.8" opacity="0.4" />
      <path d="M28 72L72 28" stroke="currentColor" strokeWidth="0.8" opacity="0.4" />
